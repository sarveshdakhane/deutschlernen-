    ...
    <main className="max-w-6xl mx-auto px-4 py-8 sm:py-10">
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_360px] gap-8 items-start">
        ...
        <div className="lg:sticky lg:top-20">
          <div className="mb-4">
            <h2 className="text-lg font-semibold text-gray-900">Pronounce</h2>
            <p className="text-xs text-gray-400 mt-0.5">Hear any German word spoken in real sentences</p>
          </div>
          <PronounceSearch compact />
        </div>
